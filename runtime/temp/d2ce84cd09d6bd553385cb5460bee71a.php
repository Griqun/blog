<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\user\add.html";i:1556502720;s:83:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1558315060;s:84:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1557884228;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		...
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">新增会员</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="username" class="col-sm-2 control-label">会员名称</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="username" name="username" placeholder="请输入会员名称">
							</div>
							</div>
							<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="file"  id="pic" name="pic" placeholder="请上传照片">
							</div>
							</div>
							...
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="添加会员" class="btn btn-success">
