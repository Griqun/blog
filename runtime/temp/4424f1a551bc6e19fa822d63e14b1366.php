<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\about\add.html";i:1559526296;s:83:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559526297;s:84:"C:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559526297;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		...
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">新增关于</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="title" class="col-sm-2 control-label">关于标题</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="请输入关于标题">
							</div>
							</div>
					    ...
					    <div class="col-sm-10">
							...
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="添加关于" class="btn btn-success">
