<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\article\index.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		<h3>文章列表</h3>
		<a href="<?php echo url('Article/add'); ?>" class="btn btn-success">新增</a>
		<table class="table table-striped table-bordered table-hover table-responsive">
			...
			<tbody>	
			<?php if(is_array($articles) || $articles instanceof \think\Collection): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?>
			<tr>
				<td><?php echo $ad['id']; ?></td>
				<td><?php echo $ad['title']; ?></td>
				<td><img src="__IMG__/<?php echo $ad['pic']; ?>" alt="" width="30" height="30"></td>
				<td><?php echo $ad['name']; ?></td>
				<td><?php echo $ad['author']; ?></td>
				<td><?php echo $ad['num']; ?></td>
				<td><?php echo $ad['zannum']; ?></td>
				<td><?php echo $ad['shounum']; ?></td>
				<td><?php echo date('Y-m-d',$ad['time']); ?></td>
				<td>
					<?php if($ad['id'] != 1): ?>
					<a href="<?php echo url('Article/del',array('id'=>$ad['id'])); ?>" onclick="return confirm('确定需要删除吗？')" class="btn btn-success btn-sm">删除</a> 
					<?php endif; ?>
					<a href="<?php echo url('Article/modify',array('id'=>$ad['id'])); ?>" class="btn btn-success btn-sm">修改</a></td>
			</tr>	
