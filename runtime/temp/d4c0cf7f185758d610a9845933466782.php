<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\user\index.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		<h3>会员列表</h3>
		<a href="<?php echo url('User/add'); ?>" class="btn btn-success">新增</a>
		<table class="table table-striped table-bordered table-hover table-responsive">
			...
			<tbody>	
		   <?php if(is_array($users) || $users instanceof \think\Collection): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?>
		   <tr>
		   	<td><?php echo $ad['id']; ?></td>
		   	<td><?php echo $ad['username']; ?></td>
		   	<td><?php echo $ad['password']; ?></td>
		   	<td><?php echo date('Y-m-d',$ad['time']); ?></td>
				<td><?php echo (isset($ad['nickname']) && ($ad['nickname'] !== '')?$ad['nickname']:"该用户未设置昵称"); ?></td>
				<td>
				<?php if($ad['pic']): ?>
				...
				<img width="80" height="80" src="__IMG__/<?php echo $ad['pic']; ?>" alt="" >    
				
				<?php else: ?>
				
				<img width="80" height="80"  src="__USER__/author.jpg" alt="">    
		   	...
		   	<td>
		   		<?php if($ad['id'] != 1): ?>
		   		<a href="<?php echo url('User/del',array('id'=>$ad['id'])); ?>" onclick="return confirm('确定需要删除吗？')" class="btn btn-success btn-sm">删除</a> 
		   		<?php endif; ?>
		   		<a href="<?php echo url('User/modify',array('id'=>$ad['id'])); ?>" class="btn btn-success btn-sm">修改</a></td>
		   </tr>	
