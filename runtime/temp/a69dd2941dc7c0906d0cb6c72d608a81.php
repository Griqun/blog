<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\comment\add.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		...
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">新增评论</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="nid" class="col-sm-2 control-label">评论文章</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="nid" name="nid" placeholder="请输入评论文章">
							</div>
							</div>
							<div class="form-group">
							<label for="uid" class="col-sm-2 control-label">评论人</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="uid" name="uid" placeholder="请输入评论人">
							</div>
							</div>
							<div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="添加评论" class="btn btn-success">
