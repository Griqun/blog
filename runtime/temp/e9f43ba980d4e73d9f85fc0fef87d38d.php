<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\friend\index.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		<h3>友情列表</h3>
		<a href="<?php echo url('Friend/add'); ?>" class="btn btn-success">新增</a>
		<table class="table table-striped table-bordered table-hover table-responsive">
			...
			<tbody>	
			<?php if(is_array($friends) || $friends instanceof \think\Collection): $i = 0; $__LIST__ = $friends;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?>
			<tr>
				...
				<td>
					<?php if($ad['id'] != 1): ?>
					<a href="<?php echo url('Friend/del',array('id'=>$ad['id'])); ?>" onclick="return confirm('确定需要删除吗？')" class="btn btn-success btn-sm">删除</a> 
					<?php endif; ?>
					<a href="<?php echo url('Friend/modify',array('id'=>$ad['id'])); ?>" class="btn btn-success btn-sm">修改</a></td>
			</tr>	
