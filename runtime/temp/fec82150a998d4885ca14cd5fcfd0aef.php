<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\cate\modify.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<!--主要工作区域开始-->
	<div class="workplace">
		<form class="form-horizontal" method="post" action="<?php echo url('Cate/update'); ?>">
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">修改栏目</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="name" class="col-sm-2 control-label">栏目名称</label>
							<div class="col-sm-10">
								<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $cate['id']; ?>">
								<input type="text" class="form-control" id="name" name="name" placeholder="请输入栏目名称" value="<?php echo $cate['name']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="sort" class="col-sm-2 control-label">栏目排序</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="sort" name="sort" placeholder="请输入栏目排序" value="<?php echo $cate['sort']; ?>">
							</div>
							</div>
