<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\article\modify.html";i:1583513244;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<!--主要工作区域开始-->
	<div class="workplace">
		<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo url('Article/update'); ?>">
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">修改文章</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="title" class="col-sm-2 control-label">文章标题</label>
							<div class="col-sm-10">
								<input type="hidden" class="form-control" id="id" name="id"  value="<?php echo $article['id']; ?>">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="keywords" name="keywords" placeholder="请输入文章关键字"  value="<?php echo $article['keywords']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="description" class="col-sm-2 control-label">文章描述</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="description" name="description" placeholder="请输入文章描述"  value="<?php echo $article['description']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="num" class="col-sm-2 control-label">文章阅读量</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="num" name="num" placeholder="请输入文章阅读量"  value="<?php echo $article['num']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="zannum" class="col-sm-2 control-label">文章点赞量</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="zannum" name="zannum" placeholder="请输入文章点赞量"  value="<?php echo $article['zannum']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="shounum" class="col-sm-2 control-label">文章收藏量</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="shounum" name="shounum" placeholder="请输入文章收藏量"  value="<?php echo $article['shounum']; ?>">
							</div>
							</div>
							<div class="form-group">
							<label for="author" class="col-sm-2 control-label">文章作者</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="author" name="author" placeholder="请输入文章作者"  value="<?php echo $article['author']; ?>">
							</div>
							</div>
							<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="typeid" id="typeid" class="form-control">
										...
										<option value="<?php echo $ca['id']; ?>" <?php if($article['typeid'] == $ca['id']): ?> selected="selected"<?php endif; ?>><?php echo $ca['name']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
							...
							<div class="col-sm-10">
								<input type="file"  id="pic" name="pic" placeholder="请输入图片上传" style="display: inline;"><img src="__IMG__/<?php echo $article['pic']; ?>" alt="" width="30" height="30">
							</div>
							</div>
					    ...
					    <div class="col-sm-10">
					    	<textarea name="text" id="content"><?php echo $article['text']; ?></textarea>
					    </div>
					    </div>
					  
							<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="修改文章" class="btn btn-success">
