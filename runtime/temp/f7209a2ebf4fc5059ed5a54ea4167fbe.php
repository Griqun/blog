<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/index\view\index\index.html";i:1582869338;s:86:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/index\view\common\header.html";i:1583216923;s:85:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/index\view\common\right.html";i:1583505049;s:86:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/index\view\common\footer.html";i:1583212381;s:89:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/index\view\common\copyright.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
										...
										<div class="col-md-8 col-sm-12">
										  ...
										  <div class="blog-post">
													...
													<div class="blog-post-more">
														<a href="<?php echo url('Article/index',array('id'=>$ar['id'])); ?>" class="btn btn-primary btn-zdy">阅读全文</a>
														<span class="tj">阅读（<?php echo $ar['num']; ?>）</span>
													</div>	
				              
											
											<div style="float:left">
													<form action="<?php echo url('Zan/index'); ?>" method="post" style="color: #fff;">
													<div class="form-group">					
														<input type="hidden" name="zanid" class="form-control" value="<?php echo $ar['id']; ?>">
													</div>	
													<div class="form-group">					
														<input type="hidden" name="uid" class="form-control" value="<?php echo \think\Request::instance()->session('id'); ?>">
													</div>	
													
													<button type="submit" class="btn btn-default" style="border:none;background:transparent;color: #828282;"><span class="glyphicon glyphicon-thumbs-up" ></span></button><?php echo $ar['zannum']; ?>
											</form>			
											</div>
											
											
											<div>
													<form action="<?php echo url('Shou/index'); ?>" method="post" style="color: #fff;">
													<div class="form-group">					
														<input type="hidden" name="shouid" class="form-control" value="<?php echo $ar['id']; ?>">
													</div>	
													<div class="form-group">					
														<input type="hidden" name="uid" class="form-control" value="<?php echo \think\Request::instance()->session('id'); ?>">
													</div>	
													
													<button type="submit" class="btn btn-default"  style="border:none;background:transparent;color: #828282;"><span class="glyphicon glyphicon-heart-empty" ></span></button><?php echo $ar['shounum']; ?>
											</form>			
											</div>
											<!--文章列表内容结束-->
											</div>
