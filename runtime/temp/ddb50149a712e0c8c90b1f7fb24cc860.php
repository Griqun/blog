<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\PHPTutorial\WWW\myblog\public/../application/admin\view\admin\add.html";i:1559694632;s:74:"E:\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:75:"E:\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<div class="workplace">
		...
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">新增管理员</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="username" class="col-sm-2 control-label">管理员名称</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="username" name="username" placeholder="请输入管理员名称">
							</div>
							</div>
							<div class="form-group">
							<label for="password" class="col-sm-2 control-label">管理员密码</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="password" name="password" placeholder="请输入管理员密码">
							</div>
							</div>
							...
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="添加管理员" class="btn btn-success">
