<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\admin\modify.html";i:1559694632;s:83:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\top.html";i:1559694632;s:84:"D:\phpStudy\PHPTutorial\WWW\myblog\public/../application/admin\view\common\left.html";i:1559694632;}*/ ?>
<!doctype html>
<html>
...
<div class="main">
	...
	<!--主要工作区域开始-->
	<div class="workplace">
		<form class="form-horizontal" method="post" action="<?php echo url('Admin/update'); ?>">
		<h5 class="page-header alert-info" style="padding: 10px;margin-top: -20px;margin-bottom: 10px;">修改管理员</h5>	
			<div class="row">
				<div class="col-md-8 col-md-offset-1">
							<div class="form-group">
							<label for="username" class="col-sm-2 control-label">管理员名称</label>
							<div class="col-sm-10">
								<input type="hidden" class="form-control" value="<?php echo $admin['id']; ?>" id="id" name="id">
								<input type="text" class="form-control" value="<?php echo $admin['username']; ?>" id="username" name="username" placeholder="请输入管理员名称">
							</div>
							</div>
							<div class="form-group">
							<label for="password" class="col-sm-2 control-label">管理员密码</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" value="<?php echo $admin['password']; ?>" id="password" name="password" placeholder="请输入管理员密码">
							</div>
							</div>
							...
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="修改管理员" class="btn btn-success">
